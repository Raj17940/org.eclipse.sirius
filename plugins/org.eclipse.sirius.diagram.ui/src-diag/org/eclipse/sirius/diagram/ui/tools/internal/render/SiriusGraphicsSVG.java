...
public class SiriusGraphicsSVG extends SiriusGraphicsToGraphics2DAdaptor implements DrawableRenderedImage {
    ...
    private static class CustomSVGGraphics2D extends SVGGraphics2D {
        ...
        public void drawString(String s, float x, float y) {
            ...
            Option<Object> currentGroup = ReflectionHelper.getFieldValueWithoutException(domGroupManager, "currentGroup"); //$NON-NLS-1$
            if (currentGroup.some() && currentGroup.get()instanceof Element) {
